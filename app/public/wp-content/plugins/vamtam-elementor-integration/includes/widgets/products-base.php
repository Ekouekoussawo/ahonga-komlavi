...
function add_content_controls( $controls_manager, $widget ) {
	...
	$widget->add_control(
		...
		[
			...
			'default' => '',
			'selectors' => [
				'{{WRAPPER}} ul.products li.product:not(.product-category) .vamtam-product-content' => 'background-color: {{VALUE}};',
			],
		]
	);
	...
	$widget->add_control(
		...
		[
			...
			'default' => '',
			'selectors' => [
				'{{WRAPPER}} ul.products li.product:not(.product-category) .vamtam-product-content:hover' => 'background-color: {{VALUE}};',
			],
		]
	);
	$widget->end_controls_tab();
