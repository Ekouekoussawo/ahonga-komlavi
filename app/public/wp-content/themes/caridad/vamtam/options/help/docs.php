		...
		<div class="main-content">
			...
			<div class="vamtam-hd-ss-wrap">
				<div class="vamtam-hd vamtam-box-wrap">
					<header>
						<h3><?php esc_html_e( 'Have any queries outside of the scope?', 'caridad' ); ?></h3>
					</header>
					<div class="content">
						<p class="vamtam-description"><?php esc_html_e( 'Should you have any queries outside of the scope of the help materials and the video guides don\'t hesitate to contact us.', 'caridad' ); ?></p>
						<a href="https://vamtam.com/contact-us/" class="vamtam-ts-button button" target="_blank">
							<?php esc_html_e( 'Contact Us', 'caridad' ); ?>
						</a>
					</div>
				</div>
				<div class="vamtam-ss vamtam-box-wrap">
					<header>
						<h3><?php esc_html_e( 'Enable System Status Information Gathering', 'caridad' ); ?></h3>
					</header>
					<div class="content">
						...
						<div id="vamtam-post-result">
							...
							<p style="color: green;" class="vamtam-post-msg-success"><?php echo esc_html__( 'Settings Saved Successfully', 'caridad' ) ?></p>
							<p style="color: red;" class="vamtam-post-msg-failure"><?php echo esc_html__( 'There was a problem saving the settings to the database, please try again.', 'caridad' ) ?></p>
						</div>
					</div>
				</div>
			</div>
