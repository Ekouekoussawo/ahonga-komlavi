<div class="post-row">
	...
	<div class="post-content-outer">
		<?php
			...
			include locate_template( 'templates/post/meta/date.php' );
		?>

		<div class="excerpt"><?php the_excerpt() ?></div>

		<a href="<?php the_permalink() ?>" title="<?php the_title_attribute() ?>" class="read-more"><?php esc_html_e( 'Read More', 'caridad' ) ?></a>
	</div>
</div>
