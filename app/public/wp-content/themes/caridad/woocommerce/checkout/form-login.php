...
<div class="woocommerce-login-form">
	<?php if ( $login_reminder_at_checkout ) : ?>
		<div class="woocommerce-form-login-toggle">
			<?php wc_print_notice( apply_filters( 'woocommerce_checkout_login_message', esc_html__( 'Returning customer?', 'caridad' ) ) . ' <a href="#" class="showlogin">' . esc_html__( 'Click here to login', 'caridad' ) . '</a>', 'notice' ); ?>
		</div>
	<?php endif; ?>
	<?php
		if ( $registration_at_checkout || $login_reminder_at_checkout ) :
			...
			woocommerce_login_form(
				array(
					'message'  => esc_html__( 'If you have shopped with us before, please enter your details below. If you are a new customer, please proceed to the Billing section.', 'caridad' ),
