...
function vamtam_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     => esc_html__( 'WooCommerce', 'caridad' ),
			'slug'     => 'woocommerce',
			'required' => true,
			'category' => 'required',
		),
		...
		array(
			'name'     => esc_html__( 'Elementor', 'caridad' ),
			'slug'     => 'elementor',
			'required' => true,
			'category' => 'required',
			'version'  => '2.7.4',
		...
		array(
			'name'     => esc_html__( 'Vamtam Elementor Integration', 'caridad' ),
			'slug'     => 'vamtam-elementor-integration',
			'source'   => VAMTAM_PLUGINS . 'vamtam-elementor-integration.zip',
			'required' => true,
			'category' => 'required',
			'version'  => '1.0.0',
		),
		...
		array(
			'name'     => esc_html__( 'Vamtam Importers (E)', 'caridad' ),
		...
		array(
			'name'     => esc_html__( 'Ally - Web Accessibility & Usability', 'caridad' ),
		...
		array(
			'name'     => esc_html__( 'GiveWP Donation Widgets for Elementor', 'caridad' ),
		...
		array(
			'name'     => esc_html__( 'Wordpress SEO', 'caridad' ),
			'slug'     => 'wordpress-seo',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'Really Simple SSL', 'caridad' ),
		...
		array(
			'name'     => esc_html__( 'Loco Translate', 'caridad' ),
			'slug'     => 'loco-translate',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'UpDraftPlus', 'caridad' ),
			'slug'     => 'updraftplus',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'LiteSpeed Cache', 'caridad' ),
		...
		array(
			'name'     => esc_html__( 'Limit Login Attempts Reloaded', 'caridad' ),
		...
		array(
			'name'     => esc_html__( 'Wordfence', 'caridad' ),
			'slug'     => 'wordfence',
			'required' => false,
			'category' => 'recommended',
		),
		...
		array(
			'name'     => esc_html__( 'CookieYes | GDPR Cookie Consent & Compliance Notice (CCPA Ready)', 'caridad' ),
...
function vamtam_tgmpa_table_columns( $columns ) {
	...
	$columns = array(
		...
		'img'         => '',
		'plugin'      => esc_html__( 'Name', 'caridad' ),
		'description' => esc_html__( 'Description', 'caridad' ),
		'status'      => esc_html__( 'Status', 'caridad' ),
		'version'     => esc_html__( 'Version', 'caridad' ),
	);
	return $columns;
}
...
function vamtam_tgmpa_table_data_item( $item, $plugin )
{
	...
	if( isset( $plugin_data['Description'] ) ) {
		...
		$item['description'] =  esc_html__( 'A simple WordPress Plugin.', 'caridad' );
	}
	if ( strpos( $plugin['slug'], 'caridad' ) !== false ) {
		$item['description'] =  esc_html__( 'Theme Exclusive.', 'caridad' );
	}
