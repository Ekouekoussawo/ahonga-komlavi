...
// Simple fix: just replace 'wp_' with 'eak_' in wp-config.php
// Only matches in wp-config.php where 'wp_' should only appear in table prefix
const fixScript = `<?php
...
console.log('Created fixed wp-fix-prefix.php');
